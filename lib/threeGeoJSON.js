...
ThreeGeo.Layer = function (json, radius, shape, options) {

    this.json = createGeometryArray(json);
    this.radius = radius;
    this.shape = shape;
...
ThreeGeo.Layer.prototype.drawGeometry = function () {
    
    var json_geom = this.json;
