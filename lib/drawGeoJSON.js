...
function drawGeoJSON(geoJSON_object, scale_value)
{
...
function drawParticle(x, y)
{
    ...
    particle_geom.vertices.push(new THREE.Vector3(x, y, 0));
...
function drawLine(x_values, y_values)
{
    ...
    function createVertexForEachPoint(object_geometry, values_axis1, values_axis2)
    {
        ...
        {
            object_geometry.vertices.push(new THREE.Vector3(values_axis1[i], values_axis2[i], 0));
        }
    }
